                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item me-5">
                            <a class="nav-link active text-dark fw-bold" aria-current="page" href="index.php?page=presentation">Qui somme nous ?</a>
                        </li>
                        <li class="nav-item me-5">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><button class="dropdown-item" id="btnSignout" data-show="connected">Déconnexion</button></li>
                                <li><a class="dropdown-item" href="compte" data-show="connected">Mon compte</a></li>
