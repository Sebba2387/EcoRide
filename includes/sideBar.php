            ...
            <nav id="sidebar" class="col-md-2 col-2 bg-dark text-white">
                ...
                <!-- Image de profil -->
                <div class="mb-4 mt-4">
                    <img src="/images/photo_profil_0.jpg" class="rounded-5 d-none d-md-block ms-1" alt="Profil" style="max-width: 100% ; max-height: 150px;">
                </div>
                <!-- Menu -->
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2 mt-2">
                        <a href="/signin" class="sidebar-item nav-link text-white">
